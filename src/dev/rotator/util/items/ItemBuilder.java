...
public class ItemBuilder {
    ...
    public ItemBuilder(Material material, int amount, String displayname) {
        if(material == null) material = Material.AIR;
        assert displayname != null : "The Displayname is null.";
        this.item = new ItemStack(material, amount);
        this.material = material;
        if(((amount > material.getMaxStackSize()) || (amount <= 0)) && (!unsafeStackSize)) amount = 1;
        this.amount = amount;
    ...
    public ItemBuilder(ItemStack item) {
        assert item != null : "The Item is null.";
        this.item = item;
        if(item.hasItemMeta())
    ...
    /**
     * Initalizes the ItemBuilder with an already existing {@link dev.rotator.util.items.ItemBuilder}
    ...
    public ItemBuilder(ItemBuilder builder) {
        assert builder != null : "The ItemBuilder is null.";
    ...
    public ItemBuilder material(Material material) {
        assert material != null : "The Material is null.";
        this.material = material;
        return this;
    }
    ...
    public ItemBuilder meta(ItemMeta meta) {
        assert meta != null : "The Meta is null.";
        this.meta = meta;
        return this;
    }
    ...
    public ItemBuilder enchant(Enchantment enchant, int level) {
        assert enchant != null : "The Enchantment is null.";
    ...
    public ItemBuilder enchant(Map<Enchantment, Integer> enchantments) {
        assert enchantments != null : "The Enchantments are null.";
    ...
    public ItemBuilder lore(String line) {
        assert line != null : "The Line is null.";
    ...
    public ItemBuilder lore(List<String> lore) {
        assert lore != null : "The List<String> lore is null.";
        this.lore = lore;
        return this;
    }
    ...
    public ItemBuilder lores(String... lines) {
        assert lines != null : "The Lines are null.";
    ...
    public ItemBuilder flag(ItemFlag flag) {
        assert flag != null : "The Flag is null.";
        flags.add(flag);
        return this;
    }
    ...
    public ItemBuilder flag(List<ItemFlag> flags) {
        assert flags != null : "The Flags are null.";
        this.flags = flags;
        return this;
    }
    ...
    public ItemBuilder owner(String user) {
        assert user != null : "The Username is null.";
